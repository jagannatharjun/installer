...
Item {
    ...
    Text {
        ...
        text: "Estimated Time: " + installer_info.totalTime
        font.family: defaultFont.name
        font.pixelSize: 13
        color: "white"
        font.weight: Font.Light
    ...
    Text {
        ...
        text: "Remaining Time: " + installer_info.remainingTime
        font.family: defaultFont.name
        font.pixelSize: 13
        color: "white"
        font.weight: Font.Light
    ...
    Rectangle {
        ...
        id: progressBar
        color: "transparent"
        property int progress: installer_info.progress
        ...
        Rectangle {
            ...
            anchors.bottom: parent.bottom
            width: (497 - border.width) * progressBar.progress / 100.0
